...
MONGO_URI = "mongodb+srv://chatchadaporn26:jjyTrRALh2lkIACn@cluster0.zpghu.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0"
...
db = client["BookBook"]  # เปลี่ยนชื่อฐานข้อมูลหากต้องการ
books_collection = db["books"]  # เปลี่ยนชื่อคอลเลกชันหากต้องการ
...
app.config['BASIC_AUTH_PASSWORD'] = 'password112'  # ตั้งค่า Password
